...
public class Test {
    ...
    public static void main(String[] args) {
        Test conversion  = new Test();
        try {
            //注意输入输出文件路径，输入输出文件分隔符“\t”
            BufferedReader bufferedReader = new BufferedReader(new InputStreamReader(new FileInputStream("C:\\Users\\lenovo\\Desktop\\111.txt")));
            OutputStreamWriter outputStreamWriter = new OutputStreamWriter(new FileOutputStream("C:\\Users\\lenovo\\Desktop\\rs.txt"));
            String data = null;
            String [] strings = null;
