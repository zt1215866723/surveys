...
import com.lfxwkj.sur.sys.modular.rest.factory.DeptFactory;
import com.lfxwkj.sur.sys.modular.rest.model.DeptTreeNode;
import com.lfxwkj.sur.sys.modular.rest.service.RestDeptService;
...
public class RestDeptController extends BaseController {
    ...
    public Object collegeList(Boolean all) {
        LoginUser user = LoginContextHolder.getContext().getUser();
        String pid = "[" + user.getDeptId() + "]";
        if(all != null){
            pid = null;
        }
        List<RestDept> list = this.restDeptService.collegeList(pid,user.getDeptId());
