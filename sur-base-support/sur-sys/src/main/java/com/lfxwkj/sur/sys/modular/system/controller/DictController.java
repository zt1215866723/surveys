...
import com.lfxwkj.sur.sys.modular.system.entity.DictType;
import com.lfxwkj.sur.sys.modular.system.model.params.DictParam;
import com.lfxwkj.sur.sys.modular.system.model.result.DictResult;
import com.lfxwkj.sur.sys.modular.system.service.DictService;
import com.lfxwkj.sur.sys.modular.system.service.DictTypeService;
...
public class DictController extends BaseController {
     ...
     */
    @ResponseBody
    @RequestMapping("/listDictsA")
    public ResponseData listDictsA(@RequestParam("dictTypeId") String dictTypeId) {
        List<Dict> dicts = this.dictService.listDictsA(Long.valueOf(dictTypeId));
        return new SuccessResponseData(dicts);
    }

    @ResponseBody
    @RequestMapping("/listDictsB")
    public ResponseData listDictsB(@RequestParam("dictTypeId") String dictTypeId) {
        List<Dict> dicts = this.dictService.listDictsB(Long.valueOf(dictTypeId));
        return new SuccessResponseData(dicts);
    }
     ...
     */
    @ResponseBody
    @RequestMapping("/listDictsByParent")
    public ResponseData listDictsByParent(@RequestParam("parentId") Long parentId) {
        List<Dict> dicts = this.dictService.listDictsByParent(parentId);
        return new SuccessResponseData(dicts);
    }
