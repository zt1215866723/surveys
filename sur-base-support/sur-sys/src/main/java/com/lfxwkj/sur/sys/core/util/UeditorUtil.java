...
public class UeditorUtil {
    ...
    public static void readFile(String fileName, HttpServletResponse response, FileType fileType, String orginalName) {
        ...
        try {
            ...
            log.error("读取文件错误！", e);
            throw new ServiceException(BizExceptionEnum.UE_FILE_READ_ERROR);
        }
    }
